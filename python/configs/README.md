...
block. For the current Rev-3 execution state only `lapv2.enabled` and
`lapv2.phase_moe` are live; leaving the block out keeps the wrapper on
the exact LAPv1 path.
