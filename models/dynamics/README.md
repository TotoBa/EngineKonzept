...
- [dynamics_merged_unique_structured_v6_v1](/home/torsten/EngineKonzept/models/dynamics/dynamics_merged_unique_structured_v6_v1)
  Current preferred Phase-6 bundle exported from [phase6_dynamics_merged_unique_structured_v6_v1.json](/home/torsten/EngineKonzept/python/configs/phase6_dynamics_merged_unique_structured_v6_v1.json). It runs the `TransitionContextV1` dynamics arm on the merged unique `110,570 / 12,286 / 2,169` corpus and is the best measured dynamics bundle so far.
...
- [dynamics_merged_unique_structured_v5_v1](/home/torsten/EngineKonzept/models/dynamics/dynamics_merged_unique_structured_v5_v1)
  Previous large-corpus symbolic-action default. Still a strong large-corpus reference, but now slightly behind the `TransitionContextV1` default.
...
- [structured_v6_v1](/home/torsten/EngineKonzept/models/dynamics/structured_v6_v1)
  First `TransitionContextV1` dynamics bundle on the `10k` corpus. It validates the richer selected-action transition contract locally and is now complemented by the promoted large-corpus default of the same family.
